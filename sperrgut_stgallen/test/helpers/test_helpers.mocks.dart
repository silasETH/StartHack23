...
// in sperrgut_stgallen/test/helpers/test_helpers.dart.
...
import 'package:sperrgut_stgallen/services/helper_service.dart' as _i8;
import 'package:sperrgut_stgallen/services/user_data_service.dart' as _i2;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUserDataService extends _i1.Mock implements _i2.UserDataService {
  @override
  _i2.CartItem get currentCartItem => (super.noSuchMethod(
        Invocation.getter(#currentCartItem),
        returnValue: _FakeCartItem_0(
          this,
          Invocation.getter(#currentCartItem),
        ),
        returnValueForMissingStub: _FakeCartItem_0(
          this,
          Invocation.getter(#currentCartItem),
        ),
      ) as _i2.CartItem);
  @override
  set currentCartItem(_i2.CartItem? _currentCartItem) => super.noSuchMethod(
        Invocation.setter(
          #currentCartItem,
          _currentCartItem,
        ),
  ...
  @override
  set receipts(List<_i2.Receipt>? _receipts) => super.noSuchMethod(
        Invocation.setter(
          #receipts,
          _receipts,
        ),
  ...
  @override
  _i6.Future<_i3.File> get localFile => (super.noSuchMethod(
  ...
  @override
  void saveToDisk() => super.noSuchMethod(
        Invocation.method(
          #saveToDisk,
          [],
        ),
  ...
  @override
  void loadFromDisk() => super.noSuchMethod(
        Invocation.method(
          #loadFromDisk,
          [],
        ),
  ...
  @override
  bool isCartEmpty() => (super.noSuchMethod(
        Invocation.method(
          #isCartEmpty,
          [],
        ),
  ...
  @override
  void createNewCart() => super.noSuchMethod(
        Invocation.method(
          #createNewCart,
          [],
        ),
  ...
  @override
  bool tryAddingItemToCart() => (super.noSuchMethod(
        Invocation.method(
          #tryAddingItemToCart,
          [],
        ),
  ...
  @override
  void setItemType(_i2.CartItemType? type) => super.noSuchMethod(
        Invocation.method(
          #setItemType,
          [type],
        ),
  ...
  @override
  void setItemSize(bool? bigSize) => super.noSuchMethod(
        Invocation.method(
          #setItemSize,
          [bigSize],
        ),
  ...
  @override
  void setItemWeight(int? weightClass) => super.noSuchMethod(
        Invocation.method(
          #setItemWeight,
          [weightClass],
        ),
  ...
  @override
  int calcTotalStampCount() => (super.noSuchMethod(
        Invocation.method(
          #calcTotalStampCount,
          [],
        ),
  ...
  @override
  bool tryDeleteCartItem(int? index) => (super.noSuchMethod(
        Invocation.method(
          #tryDeleteCartItem,
          [index],
        ),
  ...
  @override
  void buyCart(bool? paid) => super.noSuchMethod(
        Invocation.method(
          #buyCart,
          [paid],
        ),
  ...
  @override
  _i2.Receipt getLatestPurchase() => (super.noSuchMethod(
        Invocation.method(
          #getLatestPurchase,
          [],
        ),
        returnValue: _FakeReceipt_2(
          this,
          Invocation.method(
            #getLatestPurchase,
            [],
        ...
        returnValueForMissingStub: _FakeReceipt_2(
          this,
          Invocation.method(
            #getLatestPurchase,
            [],
...
/// A class which mocks [HelperService].
///
/// See the documentation for Mockito's code generation for more information.
class MockHelperService extends _i1.Mock implements _i8.HelperService {
  @override
  List<_i8.CartItemText> get cartItemTexts => (super.noSuchMethod(
        Invocation.getter(#cartItemTexts),
        returnValue: <_i8.CartItemText>[],
        returnValueForMissingStub: <_i8.CartItemText>[],
      ) as List<_i8.CartItemText>);
}
